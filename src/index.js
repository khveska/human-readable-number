...
function numberToReadable(numberStr) {
    ...
    switch (number) {
        ...
        case number < 20:
            return (teens[numberStr.slice(-1)] || digits[numberStr.slice(-1)]) + TEEN_POSTFIX;
        case number < 100:
            return (
        ...
        case number < 1000:
            return digits[numberStr[0]] + HUNDRED + numberToReadable(numberStr.slice(1));
        case number < 10000:
            return digits[numberStr[0]] + THOUSAND + numberToReadable(numberStr.slice(1));
        default:
